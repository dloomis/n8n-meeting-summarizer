...
4. **Formatting**: Markdown only. Person names: `[[People/Name|Name]]` in YAML frontmatter participants list, `**Name**` for all person names in TL;DR and Key Discussion Points, plain `Name` in Action Items. Hot takes: `> Quote - **Speaker**`
