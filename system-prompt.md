...
4. **Formatting**: Markdown only. Person names: `[[People/Name|Name]]` for all people. Hot takes: `> Quote - [[People/Speaker|Speaker]]`

5. **Participants**: YAML list extracting from the people attributed to the transcribed item as tagged in the transcription file, e.g. Richard, Erlich, Peter. Format: `- "[[People/Name|Name]]"`. Deduplicate.
